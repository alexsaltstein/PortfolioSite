...
window.onload = function () {
    ...
    $('#drunkful-link').click(function () { displayModal("Drunkful Project", "This is a description for drunkful I need to go further into depth about this later","www.drunkful.com/", [1,2,3,4].map(i => (`./assets/images/drunkful_${i}.png`))); return false;});
    $('#forkist-link').click(function () { displayModal("Forkist Project", "This is a description for forkist I need to go further into depth about this later", "www.forkist.com/", [1, 2, 3].map(i => (`./assets/images/forkist_${i}.png`))); return false; });
    $('#scholastic-link').click(function () { displayModal("Scholastic Internship", "This is a description for scholastic I need to go further into depth about this later", "www.scholastic.com/sts-associates/main/index.html", [1,2,3,4,5,6].map(i => (`./assets/images/scholastic_${i}.png`))); return false;});
    $('#north-link').click(function () { displayModal("North of Normal CBD Manager", "this is stuff about north of normal", "www.13-north.com/", [1,2,3,4].map(i => (`./assets/images/north_${i}.png`))); return false;});
